            ...
            {inPaymentStep && displayOrder && !showMyaza ? (
                ...
                <SectionCard icon={Truck} title="Delivery options">
                  <div className="flex w-full gap-4">
                    <SelectField
                      ...
                      options={[
                        { value: "lagos_pickup", label: "Free Pickup (Lagos Office)" },
                        { value: "lagos", label: "Doorstep Delivery (Within Lagos)" },
                        { value: "outside_lagos", label: "Doorstep Delivery (Outside Lagos)" },
                      ]}
                    />
                    <SelectField
                  ...
                  />
                  {(destination === "lagos" || destination === "lagos_pickup") && (
              ...
              <div className="flex min-w-0 max-w-full flex-col gap-4 rounded-[20px] border border-shop-border bg-white p-5 sm:p-7">
                ...
                <p className="text-xs text-black/60">
                  Review your shipping details below. Click &quot;Place order&quot; to proceed to payment.
                </p>
                {pendingFormData && (
