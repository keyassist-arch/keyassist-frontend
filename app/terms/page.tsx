  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-8">
      ...
      <div className="mt-10 space-y-10 text-sm leading-relaxed text-shop-ink">
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-shop-ink">5. Prohibited conduct</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-shop-ink">6. Intellectual property</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-shop-ink">7. Third-party links and services</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-shop-ink">8. Disclaimers</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-shop-ink">9. Limitation of liability</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-shop-ink">10. Governing law</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-shop-ink">11. Changes to these terms</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-shop-ink">12. Termination</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-shop-ink">13. Contact us</h2>
          <p>
