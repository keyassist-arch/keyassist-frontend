...
import { FEATURED_CATEGORIES } from "@/components/storefront/landing-categories";
...
function BrowseCategories() {
  return (
    <div className="mx-auto max-w-(--shop-layout-max) px-4 sm:px-8">
      <motion.h2
        className="mb-6 text-[32px] font-extrabold tracking-[-0.6px] text-shop-ink"
      ...
      >
        {FEATURED_CATEGORIES.map(({ name, imageUrl }) => (
          ...
          >
            <Link
              href={`/shop?category=${encodeURIComponent(name)}#shop-catalog`}
